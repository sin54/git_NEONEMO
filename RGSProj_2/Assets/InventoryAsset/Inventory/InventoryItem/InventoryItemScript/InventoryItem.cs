...
namespace InventorySystem
{
    ...
    public class InventoryItem
    {
        ...
        public InventoryItem(ItemInitializer init)
        {
            ...
            this.isWeapon= init.GetIsWeapon();
            this.itemTag = init.GetTags();
            this.itemRarity= init.GetRarity();
            this.itemSkillEvent=init.GetSkillEvent();
            this.itemGUID = init.GetGUID();
        }
        public InventoryItem(InventoryItem other, int amount = 1)
        {
            ...
            this.itemSkillEvent = other.itemSkillEvent;
            this.itemGUID = other.itemGUID;
        }
        ...
        public ItemTag GetTags() => itemTag;
        public ItemRarity GetRarity() => itemRarity;
        public void SetRarity(ItemRarity r) => itemRarity= r;
        public InventoryItemSkillEvent GetSkillEvent() => itemSkillEvent;
        public void SetGUID()
        {
            itemGUID=itemType+ Guid.NewGuid().ToString();
        }
